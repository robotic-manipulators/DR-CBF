...
if __name__ == "__main__":
    ...
    result, steps, dist_history = run_experiment(step_size, vision_noise,
                                                 use_dr=True,
                                                 enable_brown_spheres=True,
    ...
    filename = os.path.join('single_trial_results', f'DR_CBF_sigma{vision_noise}_{result}.pdf')
